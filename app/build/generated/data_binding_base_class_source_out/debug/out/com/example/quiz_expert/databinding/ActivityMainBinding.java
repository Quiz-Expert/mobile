...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button btnSignIn,
      ...
      @NonNull EditText editTextPassword, @NonNull ImageView imageLogo,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, btnSignIn, btnSignUp, editTextEmail,
          editTextPassword, imageLogo, textView);
    }
